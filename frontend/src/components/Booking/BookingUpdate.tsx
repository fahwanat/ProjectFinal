...
function BookingUpdate() {
    ...
    async function submit() {
        let data = {
            ...
            RoomID: convertType(booking.ServiceID),
            Time: booking.Time,
            //Stop: booking.Stop,
                    ...
                    <Grid item xs={6}>
                        ...
                        <Select
                            ...
                            >
                                ...
                                {u_bookings.map((item: BookingsInterface) => item.MemberID === convertType_C(localStorage.getItem('id')) && ( 
                        ...
                        <FormControl fullWidth variant="outlined">
                            ...
                            >
                                ...
                                {services.map((item: ServiceInterface) => (
                                    <option value={item.ID} key={item.ID}>
                                        ห้องพักหมายเลข: {item.Name} ราคา: {item.Price} บาท
                                    </option>
                                ))}
                            </Select>
                        </FormControl>
