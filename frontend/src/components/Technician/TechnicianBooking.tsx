...
function TechnicainBooking() {
    ...
    //     const res = await GetEmployeelist({tag, sort: selectedFilter});
    ...
    //     const filteredData = data.filter((item: EmployeeInterface) =>
...
export default TechnicainBooking
